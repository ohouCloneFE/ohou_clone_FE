...
const Login = (props) => {
  ...
  return (
    <React.Fragment>
      <Grid width = "0vw" margin = "300px auto" min = "350px" radius = "10px">
        <DivSt>
          <Grid width="auto" margin="16px">
            <Grid padding="30px 77px" margin="5px auto">
              <div>
                <svg width="147" height="50" viewBox="0 0 147 50" preserveAspectRatio="xMidYMid meet" class="css-1ekfro2 ebon26m3">
                  <g fill="none" fill-rule="evenodd">
                    <path fill="#35C5F0" d="M38.42 0H8.35C4.03 0 0 4.02 0 8.33v33.34C0 45.98 4.03 50 8.35 50h33.41c4.33 0 8.35-4.02 8.35-8.33V8.33C50.11 4.02 46.1 0 41.76 0h-3.34z">
                    ...
                    <g fill="#000">
                      ...
                      <path d="M120.65 8.5c-.93 0-1.69.75-1.69 1.68v20.6c-2.23.69-6.66 1.3-12.04 1.3h-2.57a1.68 1.68 0 1 0 0 3.37h2.57c3.07 0 8.37-.27 12.05-1.19v5.6a1.68 1.68 0 0 0 3.37 0V10.19c0-.93-.76-1.69-1.69-1.69">
            ...
            <Grid margin="20px 0px 0px 0px" padding="0px 0px">
                <Button
                  bg = "#35c5f0"
                  width = "300px"
                  text="로그인"
            ...
            <Grid margin="40px auto" padding="0px 45px" width= "300px">

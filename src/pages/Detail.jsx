...
const Detail = () => {
  ...
  <React.Fragment>
    <div style={{width : "100vw", height : "100vh", backgroundColor : "#e5e5e5"}}>
      ...
      <DetailDiv style={{borderBottom: "4px solid rgb(230, 230, 230)"}}>
        <div style={{height : "50px", width : "775px", float : "left"}}>
          ...
          <div style={{lineHeight : "50px", margin : "0px 0px 0px 60px", fontSize: "20px"}}>
            React 얼굴마담
          </div>
        ...
        <div className='upbar'>
          <div className='roomtype'>
            <div style={{display: "flex", flexDirection: "row", justifyContent: "spaceBetween"}}>
              ...
              <p className='roomtypetag'>유니크 스타일</p>
